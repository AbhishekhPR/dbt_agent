...
Severity: medium  
Data Loss Risk: no  
Generated At: 2026-06-06 13:49:30  

## Executive Summary

Relium detected a medium schema drift in raw_orders.
...
Anomaly message:
Schema drift detected: column '_relium_sim_new_column' was added

Detail:
Column did not exist in baseline but exists in current schema

Impact:
Downstream SELECT * models may change shape unexpectedly
...
1. Source connector schema evolution.  
   Confidence: 0.66  
   Reason: Schema drift detected: column '_relium_sim_new_column' was added.
