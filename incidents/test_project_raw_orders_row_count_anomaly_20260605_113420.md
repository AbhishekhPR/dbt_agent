...
Severity: critical  
Data Loss Risk: yes  
Generated At: 2026-06-05 11:34:20  

## Executive Summary

Relium detected a critical row-count anomaly in raw_orders.

raw_orders dropped from ~1 expected rows to 8 observed rows, a +700.0% decrease.
...
Anomaly message:
Row count spiked by 700.0%

Detail:
Expected ~1 rows, got 8
