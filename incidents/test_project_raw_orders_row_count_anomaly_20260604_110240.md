...
Severity: critical  
Data Loss Risk: yes  
Generated At: 2026-06-04 11:02:40  

## Executive Summary

Relium detected a critical row-count anomaly in raw_orders.

The table row count dropped from the expected baseline to the observed value, creating a potential data loss risk for downstream analytics models.
...
Start by validating the upstream ingestion process for raw_orders.

If ingestion is healthy, investigate recent SQL/filter changes and downstream joins.
