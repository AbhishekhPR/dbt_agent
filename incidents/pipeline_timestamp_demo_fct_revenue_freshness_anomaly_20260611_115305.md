...
Severity: critical  
Data Loss Risk: yes  
Generated At: 2026-06-11 11:53:05  

## Executive Summary

Relium detected a critical freshness anomaly in fct_revenue.

The anomaly in fct_revenue may affect downstream analytics models that depend on this table.

Primary hypothesis: upstream ingestion delay.

1 downstream model(s) may be affected.
...
Detail:
Latest source_max_updated_at value is 2026-06-09 11:53:03
...
Interpretation:
These models either directly or indirectly depend on fct_revenue. If fct_revenue is stale, downstream models may be using outdated data.

## Recommended Investigation Steps

1. Check whether the scheduled ingestion job for fct_revenue ran successfully.
...
First action: Verify whether the scheduled ingestion job for fct_revenue completed successfully and updated the table within the expected freshness window.
