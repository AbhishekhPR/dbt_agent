...
Severity: medium  
Data Loss Risk: no  
Generated At: 2026-06-05 09:35:19  
...
Anomaly message:
Distinct values in 'order_status' increased by 700.0%

Detail:
Was 1 distinct values, now 8
...
Reason:
Order_status distinct values increased by 6.0 points.

## Alternative Hypotheses

1. Malformed grouping.  
   Confidence: 0.26  
   Reason: Order_status distinct values increased by 6.0 points.
