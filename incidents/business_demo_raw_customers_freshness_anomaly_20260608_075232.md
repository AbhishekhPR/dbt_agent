...
Severity: critical  
Data Loss Risk: yes  
Generated At: 2026-06-08 07:52:32  
...
Anomaly message:
Table is stale by 21343.9 hours
...
1. Failed scheduled load.  
   Confidence: 0.66  
   Reason: Table is stale by 21343.9 hours.
...
Interpretation:
These models either directly or indirectly depend on raw_customers. If raw_customers is stale, downstream models may be using outdated data.
...
First action: Verify whether the scheduled ingestion job for raw_customers completed successfully and updated the table within the expected freshness window.
