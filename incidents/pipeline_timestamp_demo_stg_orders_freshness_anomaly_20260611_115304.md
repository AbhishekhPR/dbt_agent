...
Severity: critical  
Data Loss Risk: yes  
Generated At: 2026-06-11 11:53:04  

## Executive Summary

Relium detected a critical freshness anomaly in stg_orders.
...
Interpretation:
These models either directly or indirectly depend on stg_orders. If stg_orders is stale, downstream models may be using outdated data.

## Recommended Investigation Steps

1. Check whether the scheduled ingestion job for stg_orders ran successfully.
...
First action: Verify whether the scheduled ingestion job for stg_orders completed successfully and updated the table within the expected freshness window.
