...
Severity: high  
Data Loss Risk: no  
Generated At: 2026-06-06 13:49:49  

## Executive Summary

Relium detected a high schema drift in raw_orders.
...
Anomaly message:
Schema drift detected: column 'order_total' changed type from TEXT to REAL

Detail:
Column data type changed between baseline and current schema

Impact:
Aggregations, joins, and casts may behave incorrectly
...
1. Source connector schema evolution.  
   Confidence: 0.66  
   Reason: Schema drift detected: column 'order_total' changed type from TEXT to REAL.
